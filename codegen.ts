...
export type CompanyDataQueryVariables = Exact<{ [key: string]: never; }>;


export type CompanyDataQuery = { __typename?: 'Query', applicantIndividualCompanyRelations?: { __typename?: 'ApplicantIndividualCompanyRelationPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyRelation', id: string, name: string }> } | null, applicantIndividualCompanyPositions?: { __typename?: 'ApplicantIndividualCompanyPositionPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyPosition', id: string, name: string }> } | null };
 ...
 * });
 */
export function useCompanyDataQuery(baseOptions?: Apollo.QueryHookOptions<CompanyDataQuery, CompanyDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CompanyDataQuery, CompanyDataQueryVariables>(CompanyDataDocument, options);
      }
export function useCompanyDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CompanyDataQuery, CompanyDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CompanyDataQuery, CompanyDataQueryVariables>(CompanyDataDocument, options);
        }
...
export type CompanyDataQueryResult = Apollo.QueryResult<CompanyDataQuery, CompanyDataQueryVariables>;